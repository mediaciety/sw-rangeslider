...
namespace McRangeslider\Decorators;
...
class PropertyFacetHandlerDecorator implements FacetHandlerInterface
{
        ...
        foreach ($sets as $set) {
            foreach ($set->getGroups() as $group) {
                ...
                if($group->hasAttribute('core')){
                    $isRange = ($group->getAttribute('core')->toArray()['israngefilter'] == 1) ? true : false;
                }
